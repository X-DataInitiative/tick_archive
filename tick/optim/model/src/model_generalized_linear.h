...
//
#ifndef TICK_OPTIM_MODEL_SRC_MODEL_GENERALIZED_LINEAR_H_
#define TICK_OPTIM_MODEL_SRC_MODEL_GENERALIZED_LINEAR_H_
...
#endif  // TICK_OPTIM_MODEL_SRC_MODEL_GENERALIZED_LINEAR_H_
