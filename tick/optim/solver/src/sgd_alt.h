...
#ifndef TICK_OPTIM_SOLVER_SRC_SGD_ALT_H_
#define TICK_OPTIM_SOLVER_SRC_SGD_ALT_H_
...
class SGDAlt : public StoSolver {
 private:
    double step_t;
    double step;

 public:
    SGDAlt(ulong epoch_size = 0,
        double tol = 0.,
...
#endif  // TICK_OPTIM_SOLVER_SRC_SGD_ALT_H_
