...
from tick.optim.solver.build.solver import SGDMinibatch as _SGDMinibatch
...
class SGDMinibatch(SolverFirstOrderSto):
    """
    ...
    def __init__(self, step: float = None, epoch_size: int = None,
        ...
        self._solver = _SGDMinibatch(epoch_size, self.tol,
