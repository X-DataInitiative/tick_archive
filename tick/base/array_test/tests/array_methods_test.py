...
from tick.base.array_test.build import array_test as test
...
class Test(unittest.TestCase):
    ...
    def test_as_array_ptr(self):
        ...
        for array_type in self.array_types:
            ...
            #   (See file base/array_test/src/array_test.h Macro TEST_AS_ARRAY_PTR
            #   and file base/array_test/src/array_test.cpp Macro TEST_AS_ARRAY_PTR_CPP)
            #
            # 2- The typemap_out of SArrayDouble2d, SSparseArray, SSparseArray2d,
            #   SBaseArrayDouble and SBaseArrayDouble2d
            #   (see file base/array/swig/sarray_typemap_out to see how the typemap out of
