...
from tick.optim.model.base import ModelHawkes, ModelSecondOrder, ModelSelfConcordant, \
    LOSS_AND_GRAD
from tick.optim.model.build.model import ModelHawkesFixedSumExpKernLogLikList as \
    _ModelHawkesFixedSumExpKernLogLik


class ModelHawkesFixedSumExpKernLogLik(ModelHawkes,
                                    ModelSecondOrder,
                                    ModelSelfConcordant):
