...
from tick.hawkes.hawkes_fixed_expkern_leastsq import \
    ...
    def test_HawkesExpKern_model_settings(self):
        ...
        for gofit in gofits:
            ...
            if gofit == "least-squares":
                learner = HawkesExpKern(decay_array,
                                        gofit=gofit)
    ...
    def test_HawkesExpKern_penalty_C(self):
        ...
        for penalty in penalties:
            if penalty != 'none':
                ...
                with self.assertRaisesRegex(ValueError, msg):
                    HawkesExpKern(self.decays, penalty=penalty,
                                  C=-1)
    ...
    def test_HawkesExpKern_solver_random_state(self):
        ...
        for solver in solvers:
            if solver in ['bfgs', 'agd', 'gd']:
                ...
                with self.assertRaisesRegex(ValueError, msg):
                    HawkesExpKern(self.decays, solver=solver,
                                  random_state=-1)
