...
from tick.optim.model.build.model import LinkType_exponential as exponential
from tick.optim.model.build.model import LinkType_identity as identity
from tick.optim.model.build.model import ModelPoisReg as _ModelPoisReg
