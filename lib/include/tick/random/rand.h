 ...
 *
 * Each instance wraps a Mersenne Twister random number generator and generate
 * random probability distributions from it.
 */
class DLL_PUBLIC Rand {
 ...
 public:
   ...
   * \param seed : seed of the Rand object, if it is negative, a random seed
   * will be chosen (depending on timestamp and other variables)
   */
 ...
 public:
  ...
  /**
   * @brief Returns a realization of a gaussian with given mean and standard
