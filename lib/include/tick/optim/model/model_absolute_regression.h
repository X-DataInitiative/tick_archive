#ifndef TICK_OPTIM_MODEL_SRC_MODEL_ABSOLUTE_REGRESSION_H_
#define TICK_OPTIM_MODEL_SRC_MODEL_ABSOLUTE_REGRESSION_H_
...
#endif  // TICK_OPTIM_MODEL_SRC_MODEL_ABSOLUTE_REGRESSION_H_
